...
export const tasks = pgTable("tasks", {
  ...
  assignedToId: uuid("assigned_to_id").notNull().references(() => users.id, { onDelete: "cascade" }),
  assignedById: uuid("assigned_by_id").notNull().references(() => users.id, { onDelete: "cascade" }),
